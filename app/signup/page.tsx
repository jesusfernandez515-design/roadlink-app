      ...
      <div className="w-full max-w-md">
        ...
        <Link href="/" className="mb-8 flex items-center justify-center gap-2">
          <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-[var(--primary)]">
            <MapPin className="h-6 w-6 text-[var(--primary-foreground)]" />
          </div>
          <span className="text-2xl font-bold text-[var(--foreground)]">Roadlink</span>
        </Link>
        ...
        <div className="rounded-2xl border border-[var(--border)] bg-[var(--card)] p-8">
          ...
          <div className="grid grid-cols-2 gap-4">
            <button className="flex items-center justify-center gap-2 rounded-lg border border-[var(--border)] py-3 font-medium text-[var(--foreground)] transition-colors hover:bg-[var(--muted)]">
